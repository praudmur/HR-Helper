    ...
    : wxFrame(NULL, wxID_ANY, title)
{
    ...
    m_Backup_Button_AddFolder = new wxButton(panel, wx_Backup_AddFolder, "Выбрать папку", wxPoint(15, 600));
    ...
    m_MailMerge_Checkbox_AddStaticAttachments = new wxCheckBox(panel, wx_chkBox_All, "Добавить выбранные файлы", wxPoint(1050, 100));
    ...
    m_MailMerge_ListBoxAttachments = new wxEditableListBox(panel, wx_MailMerge_ListBox, ("Список вложений:"), wxPoint(15, 680), wxSize(800, 200), wxEL_DEFAULT_STYLE);
    m_MailMerge_Button_AddAttachmentFiles = new wxButton(panel, wx_MailMerge_AddAttachmentFiles, "Добавить вложения", wxPoint(15, 640));
